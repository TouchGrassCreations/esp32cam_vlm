...
void sendFrame() {
  ...
  Serial.printf("POST response: %d, image bytes: %u\n", response, fb->len);
...
void setup() {
  ...
  serverUrl = "http://" + String(SERVER_IP) + ":" +
              String(SERVER_PORT) + "/camera/frame";
...
void loop() {
  ...
  // One image every 10 seconds for the prototype.
  // Increase/decrease after the basic pipeline works.
  delay(10000);
}
